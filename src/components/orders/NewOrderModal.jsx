                ...
                <div className="bg-white max-w-xl w-full rounded-md">
                    ...
                    <form className="m-5 mx-24">
                        ...
                        <div className="flex justify-between mt-3">
                            <label className="mr-10 text-[#043912] font-medium text-lg">Customer</label>
                            <input className="border-2 w-7/12 p-1 rounded-lg" type="text" onChange={(e) => { setNewOrderForm({ ...newOrderForm, customer: e.target.value }) }} />
                        </div>
                        <div className="flex justify-between mt-3">
                        ...
                        <div className="flex justify-between mt-3">
                            ...
                            <div className="flex justify-end">
                                ...
                                <button className="text-sm text-white bg-[#73C088] rounded-md px-4 py-1" type="button" onClick={handleToggleModal2}>Import</button>
                            </div>
                        </div>
                    </form>
