...
const CuttingModal = (props) => {
    ...
    const handleOrderSubmit = async () => {
        ...
        // props.handleToggleCuttingModal();
            ...
            <div id="modal" className="flex items-center justify-center h-screen w-screen fixed inset-0 bg-black/50 overflow-auto">
                <div className="bg-white max-w-xl w-full rounded-md">
                    <div className="p-3 flex items-center justify-end">
                        <span className="modal-close cursor-pointer" onClick={props.handleToggleCuttingModal}>×</span>
                    </div>
                    <h3 className="font-semibold text-xl text-[#043912] text-center">تشافي</h3>
                    ...
                    <div className="p-3 flex items-center justify-end">
                        <div>
                            ...
                            <button className="modal-close text-sm text-[#73C088] border rounded-md px-4 py-1 ml-3" onClick={props.handleToggleCuttingModal}>Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
