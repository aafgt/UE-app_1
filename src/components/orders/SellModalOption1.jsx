...
//                         <span className="modal-close cursor-pointer" onClick={props.handleToggleSellModalOption1}>×</span>
//                     </div>
//                     <h3 className="font-semibold text-xl text-[#043912] text-center">لحم بعضم</h3>
...
//                             <button className="modal-close text-sm text-[#73C088] border rounded-md px-4 py-1 ml-3" onClick={props.handleToggleSellModalOption1}>Cancel</button>
//                         </div>
//                     </div>
//                 </div>
//             </div>
...
// export default connect(null, mapDispatchToProps)(SellModalOption1);
...
const Batch = ({ index, handleToggleModal2, batch, createOrderRes, handleCowBatches, setCreateOrderResValid }) => {
    ...
    return (
        <>
            ...
            {toggleModal22 && <ImportPieceModal cows={["123", "456"]} handleToggleModal={handleToggleModal} handleToggleModal22={handleToggleModal22} batchCode={batch.batchCode} createOrderRes={createOrderRes} handleSelectedCowType={handleSelectedCowType} handleSelectedCowsListParent={handleSelectedCowsList} />}
        </>
    );
};
...
const SellModalOption1 = (props) => {
    ...
    const handleOrderSubmit = async () => {
        ...
        // props.handleToggleSellModalOption1();
...
export default SellModalOption1;